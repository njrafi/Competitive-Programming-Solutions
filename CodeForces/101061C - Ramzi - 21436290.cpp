...
void dj(int s, int des)
{
    ...
    while (!p.empty())
    {
        ...
        For(i, v[u].sz)
        {
            ...
            {
                dis[w].ss = cu + cc;
                dis[w].ff = dis[u].ff + dd;
                p.push(info(w, dis[w].ss, dis[w].ff));
            }
            else if ((dis[w].ss == cu + cc) && (dis[w].ff > du + dd))
            {
                dis[w].ff = du + dd;
                p.push(info(w, dis[w].ss, dis[w].ff));
            }
    ...
    if (dis[des].ss >= inf)
        ...
        cout << dis[des].ss << " " << dis[des].ff + dis[des].ss << endl;
}
int main()
{
