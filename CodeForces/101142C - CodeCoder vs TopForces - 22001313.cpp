...
#define READ freopen("codecoder.in", "r", stdin)
#define WRITE freopen("codecoder.out", "w", stdout)
#define sz size()
...
int ymx[1000006], cmx[100005], ans[100005];
int main()
{
