...
i64 grid[max_x][max_y];            // present grid after updating
                                   // everything should be 1 indexed
void update(int x, int y, int val) // update point at x,y to prev + val
{
    int y1;
    while (x <= max_x)
    {
