...
bool f(int maxDis)
{
    int sou = 0;
    int sink = v.sz - 1;
    nodeFlow::init(v.sz, sou, sink, cap);
    //        cout << sou << " " << sink << endl;
    For(i, (int)v.sz - 1)
        Fre(j, i + 1, v.sz) if (abs(v[i] - v[j]) <= maxDis)
    {
        //                                i64 gg = infll;
        //                                if(!i)
        //                                        gg = 2;
        //                                cout << "edge : " ;
        //                                cout << i << " " << j << " " << gg << endl;
        nodeFlow::addEdge(i, j, infll);
    }
    int tot = nodeFlow::dinic();
    //        cout << maxDis << " " << tot << endl;
    return (tot == 2);
}
int main()
{
