...
int f()
{
    ...
    For(i, ssz)
    {
        ...
        if (r >= ssz)
            break;
        //                cout << hashString::hashOfRange(i,r) << " " << hashString::hashOfRange(0,s.sz-1,1) << endl;
        if (hashString::hashOfRange(i, r) == hashString::hashOfRange(0, s.sz - 1, 1))
            ans++;
    }
    return ans;
}
