...
//
        ...
        ui64 hashOfRange(int en,int idx = 0)
        {
...
int main()
{
        ...
        while(t--)
        {
                ...
                while(q--)
                {
                        ...
                        int lo = 0 , hi = min(szstr[a],szstr[b]) , ans;
                        while(lo<=hi)
                        {
                                int mid = (lo+hi)/2;

                                if(hashString::hashOfRange(mid,a)==hashString::hashOfRange(mid,b))
                                {
                                        ans = mid;
                                        lo = mid + 1;
                                }
