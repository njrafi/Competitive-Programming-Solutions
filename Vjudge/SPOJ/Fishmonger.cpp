...
int n,t,mt1[60][60],mt2[60][60],dis[60][1005];
...
int f()
{
        ...
        while(!p.empty())
        {
                ...
                For(i,n)
                {
                        ...
                        if(dis[i][utm+wtm]>  utl + mt2[u][i])
                        {



                                dis[i][utm+wtm] = utl + mt2[u][i];
                                tem.y = i;
                                tem.tm = utm + wtm;
                                tem.tl = dis[i][utm+wtm];
                                p.push(tem);
                        }
                }
