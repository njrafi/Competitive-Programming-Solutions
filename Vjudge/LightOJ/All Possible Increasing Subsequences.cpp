...
void update(int n,int st,int en,int idx,i64 val)
{
        ...
        tree[n] = (tree[lc] + tree[rc]) % mod;
}
 
i64 q(int n,int st,int en,int l,int r)
{
        if(l>r)
                return 0;
        ...
        i64 p1 = q(lc,st,mid,l,r) ;
        i64 p2 = q(rc,mid+1,en,l,r);
...
int main()
{
        ...
        while(t--)
        {
                ...
                For(i,v.sz)
                {
                        if(!i)
                        {
                                update(1,0,v.sz-1,v[i].ss,1);
                                continue;
                        }
 
                        i64 bef = q(1,0,v.sz-1,0,v[i].ss-1);
                        bef++;
                        bef %= mod;
                        update(1,0,v.sz-1,v[i].ss,bef);
